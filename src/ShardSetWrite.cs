...
namespace ArgentSea
{
    ...
    /// </summary>
    public class ShardSetWrite<TConfiguration> where TConfiguration : class, IShardSetsConfigurationOptions, new()
    {
        private readonly ShardSet<TConfiguration> _shardSet;
        internal ShardSetWrite(ShardSet<TConfiguration> shardSet)
        {
            _shardSet = shardSet;
        }
        #region RunAsync
